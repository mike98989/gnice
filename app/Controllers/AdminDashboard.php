...
class AdminDashboard extends Controller
{
    ...
    {
        $data = [];
        $this->view->js = ['public/assets/js/controllers/admindashboard/homeController.js', 'public/assets/js/controllers/admindashboard/usersController.js', 'public/assets/js/controllers/admindashboard/listingController.js'];
