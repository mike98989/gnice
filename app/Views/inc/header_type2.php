				...
				<div class="container">
					...
					<div class="header-right header-dropdowns ml-0 ml-sm-auto">
						...
						<ul class="d-flex mb-0 mr-3 pr-3 menu" style="margin-top: -20px!important;">
									<li class=" mr-3"><a href="#" class="social-icon social-instagram icon-instagram" title="Premium Services"></a></li>
									<li class=" mr-3"><a href="#" class="social-icon social-instagram icon-instagram" title="Advert"></a></li>
									<li class=" mr-3"><a href="#" class="social-icon social-instagram icon-instagram" title="My Messages"></a></li>
									<li class=" mr-3"><a href="#" class="social-icon social-instagram icon-instagram" title="Saved"></a></li>
									<li class=" mr-3">   <a
                      href="#"
