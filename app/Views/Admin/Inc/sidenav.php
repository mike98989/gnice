...
<div class="container-fluid page-body-wrapper" ng-controller="headerController">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
            ...
            <li class="nav-item" ng-class="{'active': menu_active == '1'}" ng-click="menu_active='1'">
            ...
            <li class="nav-item" ng-class="{'active': menu_active == '2'}" ng-click="menu_active='2'">
            ...
            <li class="nav-item" ng-class="{'active': menu_active == '3'}" ng-click="menu_active='3'">
                <a class="nav-link" href="{{dirlocation}}admindashboard/categories">
                    <span class="menu-title">Categories</span>
                    <i class="mdi mdi-sitemap menu-icon"></i>
                </a>
            </li>
            <li class="nav-item" ng-class="{'active': menu_active == '4'}" ng-click="menu_active='4'">
                <a class="nav-link" href="{{dirlocation}}admindashboard/users">
                    <span class="menu-title">All Users</span>
                    <i class="mdi mdi-account-multiple menu-icon"></i>
                </a>
            </li>
            <li class="nav-item" ng-class="{'active': menu_active == '5'}" ng-click="menu_active='5'">
            ...
            <li class="nav-item" ng-class="{'active': menu_active == '6'}" ng-click="menu_active='6'">
                <a class="nav-link" href="{{dirlocation}}admindashboard/transactions">
                    <span class="menu-title">Transactions</span>
                    <i class="mdi mdi-cash-multiple menu-icon"></i>
                </a>
            </li>
            <li class="nav-item" ng-class="{'active': menu_active == '7'}" ng-click="menu_active='7'">
                <a class="nav-link" href="{{dirlocation}}admindashboard/banners">
                    <span class="menu-title">Banners</span>
                    <i class="mdi mdi-flag menu-icon"></i>
                </a>
            </li>
            <li class="nav-item" ng-if="user_data.privilege == '3'" ng-class="{'active': menu_active == '8'}" ng-click="menu_active='8'">
