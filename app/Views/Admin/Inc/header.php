                ...
                <div class="modal-content">
                    <div class="card">
                            ...
                            <section>
                                ...
                                <div class="password_form px-5 mt-4" style="display: none;">
                                    ...
                                    <form ng-submit="change_admin_password()" id="change_password">
                                        <input type="text" name="verify_email" hidden value="{{info.email}}"
                                            id="verify_email" required>
                        ...
                        <div class="modal-footer d-flex justify-content-between px-4">
                            ...
                            <button class="btn btn-sm btn-danger m-1 password_form_inverse"
                                ng-click="toggle_password_form()"><i class="mdi mdi-adjust mr-1"></i>Change
                                Password
                            </button>


                            <button type="button" class="btn btn-light btn-sm password_form_inverse"
                                data-dismiss="modal"><i class="mdi mdi-cancel mr-1"></i>Cancel
                            </button>
                        </div>
                    </div>
                </div>
