...
//// INFORMATION GATHERING ////
    module.factory('infogathering', ['$http','$cookies','$localStorage', function($http, $cookies,$localStorage) {
    ...
    return {urlSplit:webUrl, completeUrlLocation:completeUrlLocation,user_data:user_data,user_token:user_token}
    }])
