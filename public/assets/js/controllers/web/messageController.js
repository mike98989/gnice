  ...
  module.controller('messageController', ['$scope','$filter','$sce','$http','infogathering','$routeParams','$localStorage','$sessionStorage', function($scope, $filter, $sce, $http, datagrab,$routeParams,$localStorage,$sessionStorage) {
    ...
    $scope.fetch_all_messages_to_seller = function(){
        $.ajax({
          url: $scope.dirlocation+'api/fetch_all_messages_to_seller?seller_id='+$scope.user_data.seller_id,
          type: 'GET',
          async: true,
          cache: false,
