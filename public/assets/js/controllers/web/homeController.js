     ...
     $scope.getAllBanner = function(){
      ...
      function filter_data() {
        $(".product_check").click(function() {
                   ...
                   $.ajax({
                     url: $scope.dirlocation+'api/filter_price?sub_cat_id='+ $localStorage.valueToShare4+'&min='+ minimum_price+'&max='+  maximum_price,
        type: 'GET',
  ...
  $('.loader').show();    
    ...
    $('body').delegate('.cbtn','click',function(event) {
     ...
     $scope.fetch_single_product = function(){
      ...
      $.ajax({
        url: $scope.dirlocation+'api/fetch_related_products?sub_cat_id='+ $localStorage.valueToShare3+'&brand='+ $localStorage.valueToShare2+'&product_code='+ $localStorage.valueToShare1,
        type: 'GET',
      ...
      $.ajax({
        url: $scope.dirlocation+'api/fetch_all_product_category?id='+ $localStorage.valueToShare5,
        type: 'GET',
